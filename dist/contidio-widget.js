...
function ContidioWidget() {
  ...
  this.fetchUrl = function (url) {
    ...
    fetch(url, {
      ...
      var $error = $("<div class='contidio-hint-message contidio-container'>"+options.translations.fetchError+"</div>");
